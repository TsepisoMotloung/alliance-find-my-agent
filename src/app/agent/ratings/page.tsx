...
import { Agent, User, Rating } from '@/models';
import { UserRole } from '@/types/models';
import StarRating from '@/components/ui/StarRating';

export default async function AgentRatingsPage() {
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
              <div className="flex-1 min-w-0">
                ...
                <p className="mt-1 text-alliance-gray-500">
                  View ratings and feedback from your clients
                </p>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="bg-alliance-gray-50 p-4 rounded-lg text-center">
                    ...
                    <div className="mt-2 flex justify-center">
                      <StarRating value={agent.averageRating || 0} readonly size="md" />
                    </div>
